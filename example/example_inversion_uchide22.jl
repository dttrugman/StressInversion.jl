...
data_dir = "data/"
mech_file = data_dir * "meca_Japan_Uchide2022.txt"
out_dir = "out/"
...
const binT = 1.0 # years 
const strideT = 1.0*binT # no overlap since stride and bin the same 

# output file contains run information in title
outfile = @sprintf("stress_inversion_binX-%.2f_strideX-%.2f_binY-%.2f_strideY-%.2f_binT-%.2f_strideT-%.2f.txt",
    binX,strideX,binY,strideY,binT,strideT)

# space time bounds: modify for your application
const lon0 = 128.0
const lon1 = 145.5
const lat0 = 27.5
const lat1 = 45.5
...
# minimum number of data: modify for application
...
# algorithm control paramters: can modify or leave fixed
...
#   - you would likely modify this for your application
